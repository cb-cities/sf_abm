...
def weekly_traffic(case):
    ...
    for day in day_list:
        for hour in range(3, 27):
            ...
            network_attr_df = network_attr_df[['edge_id_igraph', 'start_sp', 'end_sp', 'length', case, 'geometry']]
    ...
    network_attr_df_grp = network_attr_df_grp.rename(columns={case: 'undirected_{}'.format(case)})
