...
def weekly_traffic(case):
    ...
    network_attr_df = network_attr_df[['edge_id_igraph', 'start_sp', 'end_sp', 'lanes', 'length', 'geometry']]
    ...
    for day in day_list:
        for hour in range(3, 27):
            ...
            network_attr_df = network_attr_df[['edge_id_igraph', 'start_sp', 'end_sp', 'length', 'lanes', case, 'geometry']]
