...
def df2geojson(taz_dist_df, taz_gdf, day, hour, node_osmid):
    ...
    output_gdf.to_file(absolute_path+'/../4_validation/output/{}/uber_benchmark_DY{}_HR{}_node{}.json'.format(folder, day, hour, node_osmid), driver='GeoJSON')
...
def main():
    ...
    ### The initial graph
    sio_g = sio.mmread(absolute_path+'/../0_network/data/{}/network_sparse.mtx'.format(folder))
    ...
    node_osmid2graphid_dict = json.load(open(absolute_path+'/../0_network/data/{}/node_osmid2graphid.json'.format(folder)))
    ...
    sample_nodes_osmid = [5434001234]#, 65291602, 5022548313, 274465185]
    ...
    day = 0
    hour = 8
    g = interface.readgraph(bytes(absolute_path+'/output/{}/network_DY{}_HR{}.mtx'.format(folder, day, hour), encoding='utf-8'))
