...
def output_edges_df(edges_df, day, hour, random_seed, probe_ratio):
    ...
    ### Output
    edges_df[['edge_id_igraph', 'hour_flow', 't_avg']].to_csv(absolute_path+'/output/speed_sensor/edges_df/edges_df_DY{}_HR{}_r{}_p{}.csv'.format(day, hour, random_seed, probe_ratio), index=False)

def main(random_seed=0, probe_ratio=1):

    logger = logging.getLogger('main')
    logger.info('\n {} network, random_seed {}, probe_ratio {}'.format(folder, random_seed, probe_ratio))
...
if __name__ == '__main__':
    ...
    for probe_ratio in [1, 0.1, 0.01, 0.001, 0]:
        results_main = main(random_seed, probe_ratio)
