...
ta3 = time.time()
print('PQ ODSP: distance 1020-->20: ', sp_pq.distance(20))
print('PQ ODSP: total time {}, dijkstra() {}, route() {}, vertex list {}, \n'.format(ta3-ta0, ta1-ta0, ta2-ta1, ta3-ta2))

# ta4 = time.time()
# sp_pq_sssp = g_pq.dijkstra(1020)
# ta5 = time.time()
# route_pq_sssp = sp_pq_sssp.route(20)
# ta6 = time.time()
# path_pq_sssp = [vertex[1] for vertex in route_pq_sssp]
# ta7 = time.time()
# print('PQ SSSP: distance 1020-->20: ', sp_pq_sssp.distance(20))
# print('PQ SSSP: total time {}, dijkstra() {}, route() {}, vertex list {}, \n'.format(ta7-ta4, ta5-ta4, ta6-ta5, ta7-ta6))
...
tb2 = time.time()
path_igraph_sssp = g_igraph.get_shortest_paths(11019, weights='weight', output='epath')
tb3 = time.time()
