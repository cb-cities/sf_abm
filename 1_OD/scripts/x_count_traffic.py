...
def main(year, day):
    ...
    for hour in range(3, 27):
        intraSF_OD_df = pd.read_csv(open(absolute_path+'/../output/sf_overpass/intraSF_growth/SF_OD_YR{}_DY{}_HR{}.csv'.format(year, day, hour)))
        try:
        ...
        intercity_OD_df = pd.read_csv(open(absolute_path+'/../output/sf_overpass/intercity_growth/intercity_YR{}_HR{}.csv'.format(year, hour)))
        try:
